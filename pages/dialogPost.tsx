...
const DialogPost: NextPageWithLayout = () => {
  return (
    <>
      ...
      <Text>So first things first. In the year of writing this, I wouldn't say the <code>&lt;dialog&gt;</code> element is the brand new shiny thing out for the web. Nevertheless, I wanted to write about it, and 
