...
import { Page, Text, BackButton, ContentWrapper, Title } from '../components/SharedStyles'
...
const DialogPost: NextPageWithLayout = () => {
  return (
    <Page>
      ...
      <ContentWrapper>
        <Text>In the year of writing this, I wouldn't say the <CodeSnippet /> element is the brand new shiny thing out for the web. Nevertheless, I wanted to write about it, and 
